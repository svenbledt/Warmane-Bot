module.exports = {
    commands: {
        global_strings: {
            ...
            warmane_blocked: 'Warmane-Dienste haben diese Anfrage blockiert. Bitte versuche es später erneut.'
        },
        charname: {
            ...
            warmane_blocked: 'Warmane-Dienste sind derzeit nicht verfügbar. Bitte versuche es später erneut oder kontaktiere einen Mitarbeiter.'
        },
        globalcheck: {
    ...
    events: {
        guildMemberAdd: {
            ...
            character_not_found: 'Ich konnte diesen Charakter auf keinem Realm finden. Bitte überprüfe die Schreibweise und versuche es erneut. Unterstützte Realms: Lordaeron, Frostmourne, Icecrown, Blackrock, Frostwolf, Onyxia.'
        },
        blacklisted_word: {
