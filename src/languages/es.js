module.exports = {
    ...
    events: {
        guildMemberAdd: {
            ...
            character_not_found: 'No pude encontrar ese personaje en ningún reino. Por favor, verifica la ortografía e inténtalo de nuevo. Reinos soportados: Lordaeron, Frostmourne, Icecrown, Blackrock, Frostwolf, Onyxia.'
        },
        blacklisted_word: {
