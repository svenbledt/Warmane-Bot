module.exports = {
    commands: {
        global_strings: {
            ...
            warmane_blocked: 'Сервисы Warmane заблокировали этот запрос. Пожалуйста, попробуйте позже.'
        },
        charname: {
            ...
            warmane_blocked: 'Сервисы Warmane в настоящее время недоступны. Пожалуйста, попробуйте позже или свяжитесь с членом персонала.'
        },
        globalcheck: {
    ...
    events: {
        guildMemberAdd: {
            ...
            character_not_found: 'Я не смог найти этого персонажа ни на одном сервере. Пожалуйста, проверьте правильность написания и попробуйте снова. Поддерживаемые серверы: Lordaeron, Frostmourne, Icecrown, Blackrock, Frostwolf, Onyxia.'
        },
        blacklisted_word: {
